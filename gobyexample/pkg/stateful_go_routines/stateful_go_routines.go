...
func Run() {
	...
	// A response is executed by first performing the requested operation and then sending a value on the
...
// It might be useful in certain cases though, for example where you have other channels involved
// or when managing multiple such mutexes would be error-prone.
