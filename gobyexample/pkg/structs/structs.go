...
func newPerson(name string) *person {
	...
	// Go is a garbage collected language; you can safely return a pointer
	// to a local variable - it will only be cleaned up by the garbage
	// collector when there are no active references to it.
