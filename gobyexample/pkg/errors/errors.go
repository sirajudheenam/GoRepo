...
// This contrasts with the exceptions used in languages like Java, Python
...
func Run() {
	...
	for i := range 5 {
		if err := makeTea(i); err != nil {
			...
			// This is especially useful with wrapped or nested errors, allowing you to identify
			//  specific error types or sentinel errors in a chain of errors.
